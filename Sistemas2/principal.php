...
<body>
	...
	<ul class="topnav">
		...
		<li class="dropdown">
    		...
    		<div class="dropdown-content">
      			<a>
					<label onClick="insertar('Contenido/Atas/Panel.php')">Ata's</label>
				</a>
				<a>Telefonos Ip</a>
				<a>Extenciones</a>
    		</div>
		...
		<li><a><label onClick="insertar('Contenido/UsuariosSistema/Panel.php')">Usuarios</label></a></li>
		<li class="dropdown">
