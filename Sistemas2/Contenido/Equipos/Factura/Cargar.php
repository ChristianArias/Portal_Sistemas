<?php
	...
	$carpeta = ("C:/Users/Administrador/Documents/Compartidos/Sistemas/Equipos/Facturas/");
	...
	/*if($size>500000){
		...
		$con = "UPDATE _equipos SET factura = '$destino' WHERE id = $id";
