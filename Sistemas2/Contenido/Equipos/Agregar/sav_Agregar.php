<?php
	...
	$sql = "INSERT INTO _equipos 	(serie,marca,modelo,area,agencia,tipo,comentarios,usuario,procesador,arquitectura,ram,discoduro,so,winoem,wininst,nombre,nombreRed,ip,ethernet,wifi,paq0,paq1,paq2,antivirus,activo)
	VALUES	('$serie','$marca','$modelo',$area,$agencia,$tipo,'$comentarios',$usuario,'$procesador','$arquitectura','$memoria','$dd','$so','$winoem','$wininst','$hostname','$hostname','$ip',$ethernet,$wifi,$office,$office1,$office2,$antivirus,1)";
