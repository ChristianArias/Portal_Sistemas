			...
			if(Boolean(serie)){
				...
				if( Boolean(validarIp(ip)) ){//&& Boolean(validarIp(ip))){
					...
					if(Boolean(nameRed)){
						...
						var mnsj = "tipo="+tipo+"&marca="+marca+"&modelo="+modelo+"&serie="+serie+"&asignado="+usuario+"&area="+area+"&agencia="+agencia+"&comentarios="+comentarios+"&procesador="+procesador+"&arquitectura="+arquitectura+"&memoria="+memoria+"&slots="+slots+"&dd="+dd+"&ddserie="+ddserie+"&so="+so+"&winoem="+winoem+"&wininst="+wininst+"&servcpack="+servcpack+"&hostname="+nameRed+"&ip="+ip+"&wifi="+wifi+"&ethernet="+ethernet+"&office0="+of[0]+"&office1="+of1[0]+"&office2="+of2[0]+"&antivirus="+antivirus;
